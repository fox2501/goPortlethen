    ...
    <form action="submitCCForm.php" class="ui form" enctype="multipart/form-data" method="post">
        ...
        <div class="ui form attached fluid segment">
            ...
            <div class="field">
                <div class="ui label">
                    http://
                </div><label>Website URL</label> <input name="websiteURL" placeholder="Website URL" type="url">
            </div>
            <div class="field">
                <label>Please toggle if your club requires a fee:</label>
                <div class="ui toggle checkbox">
                    <input class="hidden" id="isFee" name="feeRequired" tabindex="0" type="checkbox" value="0"> <label for="isFee">Fee does apply</label>
                </div>
            </div>
            <div class="field" id="feeAmount" style="display: none;">
                ...
                <div class="ui right labeled input">
                    <div class="ui label">
                        £
                    </div><input name="feeAmount" placeholder="Amount" type="text">
                </div>
                <script>
