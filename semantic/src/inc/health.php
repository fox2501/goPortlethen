    ...
    <div class="ui stackable two column grid">
        <div class="ten wide column">
            ...
            if ($accessLevel == 1 || $accessLevel == 4) {
                echo "
	<div class='row'>
		<a href='healthForm.php'><button class='ui green submit button' style='margin-right:50px'>Submit Content</button></a>
	</div>";
            }
            ?>
            <div class="row">
        ...
        <div class="six wide column">
            <div data-tockify-calendar="healthevents" data-tockify-component="mini"></div>
            <script data-tockify-script="embed" src="https://public.tockify.com/browser/embed.js">
            </script> <?php
            if ($accessLevel == 1 || $accessLevel == 4) {

                echo "
				                <button class='ui green submit button' ><a href = 'https://tockify.com/tkf2/submitEvent/42648d506ec74f769ce92685c0fe921e'
				                                          style = 'color: white' > Submit an Event </a ></button >
				            ";}
            ?>
